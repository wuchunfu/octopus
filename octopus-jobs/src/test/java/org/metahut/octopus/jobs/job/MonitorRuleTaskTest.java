...
public class MonitorRuleTaskTest {
    ...
    public static Stream<List<String>> metricMessageProvider() throws IOException {
        List<MetricMessage> metricMessages = objectMapper.readValue(MonitorRuleTaskTest.class.getClass().getResourceAsStream("/json/metrics.json"),
