...
public enum StatusEnum {
    ...
    ALERT_SOURCE_NOT_EXIST(20102, "ALERT_SOURCE_NOT_EXIST"),
    SAMPLE_INSTANCE_NOT_EXIST(20103, "SAMPLE_INSTANCE_NOT_EXIST"),
    FLOW_DEFINITION_CODE_NOT_EXIST(20104, "FLOW_DEFINITION_CODE_NOT_EXIST"),
