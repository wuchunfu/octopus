...
public enum StatusEnum {
    ...
    METRICS_NAME_OR_CODE_EXIST(20012, "METRICS_NAME_OR_CODE_EXIST"),
    METRICS_CODE_UPDATE_ERROR(20013, "METRICS_CODE_UPDATE_ERROR"),
    ...
    RULE_TEMPLATE_EXIST(20061, "RULE_TEMPLATE_EXIST"),
