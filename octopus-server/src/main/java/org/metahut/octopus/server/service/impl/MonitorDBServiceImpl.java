...
public class MonitorDBServiceImpl implements MonitorDBService {
    ...
    public MonitorDBServiceImpl(IMonitorDBSource monitorDBSource, ConversionService conversionService, MetricsConfigService metricsConfigService) {
    ...
    public PageResponseDTO<MonitorLogResponseDTO> queryMonitorLogListPage(MonitorLogConditionsRequestDTO requestDTO) {
        ...
        converts.forEach(monitorLog -> {
            MetricsConfigResponseDTO metricsConfig = metricsConfigService.findByCode(monitorLog.getMetricsConfigCode());
            monitorLog.setMetricsConfigName(metricsConfig.getName());
            monitorLog.setMetricsName(metricsConfig.getMetrics().getName());
        });
